...
describe("PolkadotAgentKit Integration Test with Key Types", function () {
  ...
  beforeEach(() => {
    ...
    sinon
      .stub(PolkadotAgentKit.prototype, "getConnection")
      .resolves({ api: mockApi, disconnect: () => {} });

    sinon.stub(PolkadotAgentKit.prototype, "waitForInitialization").resolves();

    sinon.stub(PolkadotAgentKit.prototype, "disconnectAll").resolves();
  });
