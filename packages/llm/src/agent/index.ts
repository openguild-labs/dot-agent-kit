// import { ChainConfig, AgentConfig, KeyType, Api, KnowChainId, SmoldotClient, Chain, ChainId, getChainSpec, getApi, getRelayChainClient, ChainRelay, getParaChainClient } from "@dot-agent-kit/common"
// import { IPolkadotToolApi } from "@dot-agent-kit/core"
// import { ed25519 } from "@noble/curves/ed25519"
// import { sr25519CreateDerive, ed25519CreateDerive } from "@polkadot-labs/hdkd"
// import { entropyToMiniSecret, mnemonicToEntropy } from "@polkadot-labs/hdkd-helpers"
// import * as ss58 from "@subsquid/ss58"
// import { PolkadotClient } from "polkadot-api";
// import { isRelayChain, isParachain } from "@dot-agent-kit/common"
...
//  * ```
//  */
// export class PolkadotAgentKit implements IPolkadotToolApi {
//   protected api!: Api<KnowChainId>;
//   protected chainId: ChainId;
//   protected chains: Chain[];
//   protected smoldotClient: SmoldotClient;
...
//   private connections: Map<string, Api<KnowChainId>> = new Map<string, Api<KnowChainId>>()
...
//    */
//   constructor(config: AgentConfig, chainId: ChainId, chains: Chain[], smoldotClient: SmoldotClient) {
...
//   public async initializeApi(): Promise<Api<KnowChainId>> {
//     const chainSpec = getChainSpec(this.chainId)
//     this.api = await getApi(this.chainId, this.chains, true, {
//       enable: true,
//       smoldot: this.smoldotClient,
//       chainSpecs: { [this.chainId]: chainSpec }
//     })
//     return this.api as Api<KnowChainId>
//   }

//   public async createClient(): Promise<PolkadotClient> {
//     const chain = this.chains.find(chain => chain.id === this.chainId)
//     if (!chain) {
//       throw new Error(`Chain ${this.chainId} not found`)
//     }
//     if (isRelayChain(chain)) {
//       return getRelayChainClient(chain as ChainRelay, {
//         lightClients: {
//           enable: true,
//           smoldot: this.smoldotClient,
//           chainSpecs: { [this.chainId]: this.getChainSpec() }
//         }
//       })
//     } else if (isParachain(chain)) {
//       return getParaChainClient(chain as Chain, {
//         lightClients: {
//           enable: true,
//           smoldot: this.smoldotClient,
//           chainSpecs: { [this.chainId]: this.getChainSpec() }
...
//   }
//   getChainSpec(): string {
//     return getChainSpec(this.chainId)
//   }
